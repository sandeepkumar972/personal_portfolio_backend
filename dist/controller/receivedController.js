...
var receivedMessage = require("../Models/receiveMessageModel");
var secretKey = require("../Models/secretKey");
var users = require("../Models/userModel");
var getMessage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res, next) {
    var _req$body$data, userData, userSecret, existUser, secretData, message;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$body$data = req.body.data, userData = _req$body$data.userData, userSecret = _req$body$data.userSecret; // console.log(req.query);
          _context.next = 3;
        ...
        case 19:
          _context.next = 21;
          return receivedMessage.find().sort({
            createdAt: -1
          });
        case 21:
  ...
  return function getMessage(_x, _x2, _x3) {
...
var sendMessage = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.prev = 1;
          _context2.next = 4;
          return receivedMessage.create(data);
        case 4:
  ...
  return function sendMessage(_x4, _x5, _x6) {
...
var deleteMessage = /*#__PURE__*/function () {
  ...
  return function deleteMessage(_x7, _x8, _x9) {
